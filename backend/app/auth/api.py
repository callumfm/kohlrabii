...
from app.supabase import AsyncSupabaseClient
...
@router.post("/sign-up")
async def sign_up(
    supabase_client: AsyncSupabaseClient, form_data: UserSignUp
) -> Message:
...
@router.post("/sign-in")
async def sign_in(
    supabase_client: AsyncSupabaseClient, form_data: UserSignIn
) -> Message:
    try:
...
async def sign_out(supabase_client: AsyncSupabaseClient) -> None:
    await supabase_client.auth.sign_out()


@router.post("/forgot-password")
async def forgot_password(
    supabase_client: AsyncSupabaseClient, form_data: UserForgotPassword
) -> Message:
    try:
...
async def update_user(
    supabase_client: AsyncSupabaseClient, user_in: UserUpdate
) -> Message:
    try:
